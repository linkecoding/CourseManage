...
<div id="preloader">
    <div id="status"><i class="fa fa-spinner fa-spin"></i></div>
        ...
        <section>
                    ...
                    <ul class="nav nav-pills nav-stacked nav-bracket">
                        <li class="nav-parent nav-active nav-hover"><a href=""><i class="fa fa-edit"></i> <span>个人中心</span></a>
                            <ul class="children" style="display: block;">
                                ...
                                <li class="active"><a href="modify-info.jsp"><i class="fa fa-caret-right"></i>修改信息</a></li>
                            </ul>
                        </li>
          ...
          <div>
          <form id="basicForm" action="./servlet/TeacherInfoModifyServlet" class="form-horizontal" method="post">
          <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">基本信息修改</h4>
                <p>请修改你的姓名，邮箱，密码，所属院系</p>
              </div>
              <div class="panel-body">
                <div class="form-group">
                  <label class="col-sm-3 control-label">姓名 <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="teacher_name" class="form-control" placeholder="请输入姓名" required="" value="${sessionScope.teacher_info.getTeacherName()}">
                  </div>
                </div>
                <input type="hidden" name="teacher_id" value="${sessionScope.teacher_info.getTeacherId()}">
                <div class="form-group">
                  <label class="col-sm-3 control-label">邮箱 <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="email" name="teacher_email" class="form-control" placeholder="请输入邮箱" required="" value="${sessionScope.teacher_info.getTeacherEmail()}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">密码 <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="password" name="teacher_password" class="form-control" placeholder="请输入密码" required="">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">确认密码 <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="password" name="confirm_password" class="form-control" placeholder="请输入确认密码" required="">
                  </div>
                </div>
    			
    			<div class="form-group">
                  <label class="col-sm-3 control-label">所属院系<span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <select class="select2" data-placeholder="请选择院系" required style="width: 100%;" name="department_id">
                            <option></option>
